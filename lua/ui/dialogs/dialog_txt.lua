...
english = {
	...
	---------------------------------------------------- in english ------------------------------------------------
		...
		--==
		["<LOC tb020>total units built"]="Total Units Built",
		...
		-- ==== stat panel
		-- page name
		Standard="<LOC tb001>Standard",
		Score=" ",
		Chart="<LOC tb003>Chart",
		Graph="<LOC tb004>Graph",
		noData="<LOC tb005>no data avaible",
		
		-- title bar
		mass_histo="<LOC tb011>Mass details",
		energy_histo="<LOC tb012>Energy details",
		built_histo="<LOC tb013>Unit/Structure built details",
		main_histo=" ",
		kills_histo="<LOC tb014>Unit/Structure kill details",
		
		-- button
		mass_histo_btn="<LOC tb010>Mass",
		energy_histo_btn="<LOC tb009>Energy",
		built_histo_btn="<LOC tb008>Built Stats",
		main_histo_btn="<LOC tb006>Overview",
		kills_histo_btn="<LOC tb007>Kill Stats",
		
		score_btn="<LOC tb002>Score",
		total_built_btn="<LOC tb015>Total built",
		total_kills_btn="<LOC tb016>Total kills",
		mass_btn="<LOC tb017>Mass in",
		energy_btn="<LOC tb018>Energy in",
		total_lost_btn="<LOC tb019>Total lost",
		
		-- tooltips
		Mass_wasted="<LOC tb049>Mass wasted during the game.",
		Mass_incoming="<LOC tb050>Mass earned during the game.",
		Mass_outgoing="<LOC tb051>Mass used during the game.",
		Energy_wasted="<LOC tb052>Energy wasted during the game.",
		Energy_incoming="<LOC tb053>Energy earned during the game.",
		Energy_outgoing="<LOC tb054>Energy used during the game.",
		air="<LOC tb055>Air units.",
		land="<LOC tb056>Land units.",
		naval="<LOC tb057>Naval units.",
		cdr="<LOC tb058>ACUs.",
		xp="<LOC tb059>Experimentals.",
		struct="<LOC tb060>Structures.",
		winner="<LOC tb061>WINNER! This player is the best in this category.",
		mass="<LOC tb062>Mass.",
		energy="<LOC tb063>Energy.",
		built_units="<LOC tb064>Total units/structures built during the game.",
		kills_units="<LOC tb065>Total units/structures killed during the game.",
		cmd_kill="<LOC tb066>Number of ACU kills.",
	}
...
francais = {
	...
	---------------------------------------------------- en fran鏰is ------------------------------------------------
		...
		--==
		["<LOC tb020>total units built"]="unites construites totals",
