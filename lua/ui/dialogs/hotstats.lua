...
local info_dialog = {   -- CHANGE THE TEXT IN DIALOG_TXT.LUA !!!!!
 {name="<LOC tb020>total units built", path={"general","built","count"},key=1},
 {name="<LOC tb021>units still alive", path={"general","currentunits","count"},key=2},
 {name="<LOC tb022>total energy in", path={"resources","energyin","total"},key=8},
 {name="<LOC tb023>total mass in", path={"resources","massin","total"},key=11},
 {name="<LOC tb002>score", path={"general","score",false},key=5},
 {name="<LOC tb024>total kills", path={"general","kills","count"},key=6},
 {name="<LOC tb025>total lost", path={"general","lost","count"},key=7},
-- {name="energy all", path={"general","built","energy"},key=3},
 {name="<LOC tb026>energy rate", path={"resources","energyin","rate",fac_mul=10},key=59},
 {name="<LOC tb027>total energy out", path={"resources","energyout","total"},key=9},
 {name="<LOC tb028>total energy wasted", path={"resources","energyover",false},key=10},
-- {name="mass all", path={"general","built","mass"},key=4},
  {name="<LOC tb029>mass rate", path={"resources","massin","rate",fac_mul=10},key=59},
 {name="<LOC tb030>total mass out", path={"resources","massout","total"},key=12},
 {name="<LOC tb031>total mass wasted", path={"resources","massover",false},key=13},
 {name="<LOC tb032>units air built", path={"units","air","built"},key=14},
 {name="<LOC tb033>units air kills", path={"units","air","kills"},key=15},
 {name="<LOC tb034>units air lost", path={"units","air","lost"},key=16},
 {name= "<LOC tb035>units land built", path={"units","land","built"},key=17},
 {name="<LOC tb036>units land kills", path={"units","land","kills"},key=18},
 {name="<LOC tb037>units land lost", path={"units","land","lost"},key=19},
 {name= "<LOC tb038>units naval built", path={"units","naval","built"},key=20},
 {name="<LOC tb039>units naval kills", path={"units","naval","kills"},key=21},
 {name="<LOC tb040>units naval lost", path={"units","naval","lost"},key=22},
 {name= "<LOC tb041>units xp built", path={"units","experimental","built"},key=23},
 {name="<LOC tb042>units xp kills", path={"units","experimental","kills"},key=24},
{name= "<LOC tb043>units xp lost", path={"units","experimental","lost"},key=25},
{ name= "<LOC tb044>units struct built", path={"units","structures","built"},key=26},
{name= "<LOC tb045>units struct kills", path={"units","structures","kills"},key=27},
{name= "<LOC tb046>units struct lost", path={"units","structures","lost"},key=28},
-- {name="units cdr built", path={"units","cdr","built"},key=29},
 {name="<LOC tb047>units cdr kills", path={"units","cdr","kills"},key=30},
 {name="<LOC tb048>units cdr lost", path={"units","cdr","lost"},key=31}}
...
function Set_graph(victory, showCampaign, operationVictoryTable, dialog, standardScore)
	...
	dual_btn = CreateDialogTabs(dialog, "对比", "r")
