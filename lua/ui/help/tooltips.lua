...
Tooltips = {
	...
	options_assist_mex = {
        title = "<LOC OPTIONS_0273>自动给T2，T3矿井围罐子",
    ...
    lob_auto_lvsr = {
        ...
        description = "<LOC lobuiz_0599>Slots in the left half of the map against those in the right half",
    },
    lob_auto_pvsi = {
        title = "<LOC lobuiz_0600>Odd vs Even",
        description = "<LOC lobuiz_0601>Odd numbered slots vs even numbered slots. Subject to map design, your mileage may vary",
    },
    lob_auto_manual = {
    ...
    options_gui_bigger_strat_build_icons = {
        title = '更大的战略建造图标',
        description = '用更显眼的图标替换默认战略图标.',
    },
    options_gui_template_rotator = {
        title = '建筑模板可翻转',
        description = '允许使用鼠标中键旋转建造模板.',
    },
    options_gui_scu_manager = {
        title = 'SCU管理器',
        description = '允许SCU能够自动升级或点击升级.',
    },
    options_gui_draggable_queue = {
        title = '可拖动建造队列',
        description = '允许通过拖拽改变工厂建造队列的排序.',
    },
    options_gui_idle_engineer_avatars = {
        title = '中键单击图标',
        description = '允许使用鼠标中键选中空闲工程车的图标来选中屏幕中所有空闲的工程车.',
    },
    options_gui_all_race_templates = {
        title = '允许创建四族通用模板',
        description = '允许使用全部阵营的建造模板.',
    },
    options_gui_enhanced_unitview = {
        title = '单个单位选中信息',
        description = '用进度条代替油料条并在选中单个单位时始终显示该单位的视图.',
    },
    options_gui_enhanced_unitrings = {
        title = '单个单位的选中环',
        description = '当选中一个单位时，显示该单位的距离环.',
    },
    options_gui_templates_factory = {
        title = '工厂建造队列模板',
        description = '允许创建工厂的建造模板.',
    },
    options_gui_seperate_idle_builders = {
        title = '独立闲置提示',
        description = '使用一个单独的图标将闲置工程车与其他建设者区分开来.',
    },
    options_gui_visible_template_names = {
        title = '显示模板名字',
        description = '在模板图标下面显示模板的名字.',
    },
    options_gui_template_name_cutoff = {
        title = '模板名字长度截取',
        description = '（默认）显示前7个字符。可定制省略的字符数，（需要重启游戏才可生效）。',
    },
    options_gui_detailed_unitview = {
        title = '显示更多单位状态',
        description = '显示护盾Hp，恢复速度，Hp恢复速度，建造速度。是Eni借鉴Total Veterancy的功能加入的.',
    },
    options_gui_display_reclaim_totals = {
        title = '总是显示自定义名称',
        description = '切换显示自定义名称。默认启用.',
    },
    options_gui_render_custom_names = {
        title = '强制显示敌方生命值',
        description = '强制显示敌方生命值，默认启用.',
    },
    options_gui_render_enemy_lifebars = {
        title = '在建造菜单显示装备细节',
        description = '在建造菜单下显示单位所带武器的详细信息',
    },
    options_gui_improved_unit_deselection = {
        title = '增强单位的撤销选择',
        description = '在组选择中按shift（-1）或Ctrl（-5），或按Ctrl + Shift（-10）并使用右击以减少选中的单位数。默认启用',
    },
    options_gui_zoom_pop_distance = {
        title = '一键缩放',
        description = '调整一键缩放的缩放距离.',
    },
    options_gui_smart_economy_indicators = {
        title = '显示可回收质量价值',
        description = '按住Ctrl+ Shift，可以在地图上显示可回收物的价值.',
    },
    #**********************
    #** 新UI界面调整
    #**********************
	...
	lob_ping = {
        title = '<LOC lobui_ping>ping',
        description = '<LOC lobui_ping2>ping',
    },
		lob_humAix_none = {
        title = '<LOC lobui_humaix0>无',
        description = '<LOC lobui_humaix00>无加成',
    },
		lob_humAix_1 = {
        title = '<LOC lobui_humaix1>1.1',
        description = '<LOC lobui_humaix01>1.1加成',
    },	lob_humAix_2 = {
        title = '<LOC lobui_humaix2>1.2',
        description = '<LOC lobui_humaix02>1.2加成',
    },
		lob_humAix_3 = {
        title = '<LOC lobui_humaix3>1.3',
        description = '<LOC lobui_humaix03>1.3加成',
    },	lob_humAix_4 = {
        title = '<LOC lobui_humaix4>1.4',
        description = '<LOC lobui_humaix04>1.4加成',
    },
		lob_humAix_5 = {
        title = '<LOC lobui_humaix5>1.5',
        description = '<LOC lobui_humaix05>1.5加成',
    },	lob_humAix_6 = {
        title = '<LOC lobui_humaix6>1.7',
        description = '<LOC lobui_humaix6>1.7加成',
    },
		lob_humAix_7 = {
        title = '<LOC lobui_humaix7>1.8',
        description = '<LOC lobui_humaix07>1.8加成',
    },	lob_humAix_8 = {
        title = '<LOC lobui_humaix8>2.0',
        description = '<LOC lobui_humaix08>2.0加成',
    },
		lob_humAix_9 = {
        title = '<LOC lobui_humaix9>3.0',
        description = '<LOC lobui_humaix09>3.0加成',
    },
		lob_humAix = {
        title = '<LOC lobui_humaix>玩家收入与建造倍数设置',
        description = '<LOC lobui_humaixDec>收入和建造速度按倍数增加',
    },
		options_gui_main_style = {
        title = '更改主菜单风格主题',
        description = '调整主菜单主题的显示风格',
    },
		options_fps_setting = {
        title = '更改帧率限制',
        description = '适用于电竞屏，调整帧率限制器是否启用',
    },
}
