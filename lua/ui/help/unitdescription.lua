...
##UEF Units
   ...
   ['uel0301_Rambo'] = "<LOC uel0301_Rambo_help>Support Armored Command Unit. Enhanced during construction with a personal shield, energy accelerator and heavy plasma refractor enhancements.",
	['uel0301_ResourceAllocation'] = "<LOC uel0301_RAS_help>ResourceAllocation enhancement. ",
   ...
   ['url0301_Stealth'] = "<LOC url0301_Stealth_help>Support Armored Command Unit. Enhanced during construction with the personal stealth generator enhancement.",
	['url0301_ResourceAllocation'] = "<LOC url0301_RAS_help>ResourceAllocation enhancement. ",
   ##Land units
   ...
   ['ual0301_ResourceAllocation'] = "<LOC ual0301_RAS_help>ResourceAllocation enhancement. ",
   ##Land
   ...
   # New Units
	['drlk001'] = "<LOC Unit_Description_700001> Advanced mobile anti-air unit. Utilizing a crude but effective target painter the Bouncer can lead it's missile salvo even to the fastest advanced aircraft. It can also use it's missiles as anti-ground rockets without guidance.",
	['drlk005'] = "<LOC Unit_Description_700005> Advanced mobile anti-air unit. Utilizing a crude but effective target painter the Bouncer can lead it's missile salvo even to the fastest advanced aircraft. It can also use it's missiles as anti-ground rockets without guidance.",
	['delk002'] = "<LOC Unit_Description_700002> Advanced mobile anti-air unit. The Cougar is armed with dual high precision AA gatling cannons, capable of hitting even the faster high-end planes.",
	['dalk003'] = "<LOC Unit_Description_700003> Advanced mobile anti-air unit. The Redeemer carries safely inside it's covers a modified anti-air variant of the powerful Serpentine missile.",
	['dslk004'] = "<LOC Unit_Description_700004> Advanced mobile multipurpose unit. Using an uncontained power generator core the Uyanah can unleash powerful and swift lightning strikes at aerial targets. It can also generate a secondary flux to a grounded target.",
}
