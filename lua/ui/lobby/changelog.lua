...
function CreateUI(parent, showPatch)
    ...
    -- Title
    local Title = UIUtil.CreateText(TextBG, LOC("<LOC lobui_0412>What's new to Version?"), 17, 'Arial Gras', true)
    ...
    local VersionText = UIUtil.CreateText(TextBG,LOC("<LOC lobui_VersionText>Select a patch: "), 15, UIUtil.bodyFont)
    ...
    local GithubButton = UIUtil.CreateButtonWithDropshadow(dialogContent, '/BUTTON/medium/', "录像站")
