...
restrictedUnits = {    
    ...
    T3MOBILEAA = {
        ...
        name = "<LOC restricted_units_data_021>No T3 Mobile Anti-Air",
    ...
    SALVAMAVOSCATH = {
        categories = {"uab2302", "urb2302", "ueb2302","xsb2302"},
        name = "<LOC restricted_units_data_024>没有T3重炮",
	...
	TML = {
	    categories = {"ueb2108", "uab2108", "urb2108", "xsb2108"},
        name = "<LOC restricted_units_data_030>No T2StrategicMissiles",
        tooltip = "restricted_units_T2StrategicMissile"
        },
}
